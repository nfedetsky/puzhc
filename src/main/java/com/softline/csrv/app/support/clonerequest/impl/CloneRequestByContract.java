...
/**
 Сервис для клонирования заявок по Контракт
 */
@Service
public class CloneRequestByContract implements ICloneRequest {
    private final Logger log = LoggerFactory.getLogger(CloneRequestByContract.class);

    private final CloneRequestService cloneRequestService;
    @Autowired
    public CloneRequestByContract(CloneRequestService cloneRequestService) {
