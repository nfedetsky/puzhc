...
/**
 Сервис для клонирования заявок по CloneRequestByVisAgreement
 */
@Service
public class CloneRequestByVisAgreement implements ICloneRequest {
    private final Logger log = LoggerFactory.getLogger(CloneRequestByVisAgreement.class);

    private final CloneRequestService cloneRequestService;
    @Autowired
    public CloneRequestByVisAgreement(CloneRequestService cloneRequestService) {
